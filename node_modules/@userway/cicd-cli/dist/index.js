#! /usr/bin/env node
'use strict';var e=require('winston'),m=require('@userway/cicd-core'),commander=require('commander'),lockfile=require('lockfile');function _interopNamespace(e){if(e&&e.__esModule)return e;var n=Object.create(null);if(e){Object.keys(e).forEach(function(k){if(k!=='default'){var d=Object.getOwnPropertyDescriptor(e,k);Object.defineProperty(n,k,d.get?d:{enumerable:true,get:function(){return e[k]}});}})}n.default=e;return Object.freeze(n)}var e__namespace=/*#__PURE__*/_interopNamespace(e);var m__namespace=/*#__PURE__*/_interopNamespace(m);e__namespace.addColors({info:"cyan",error:"red",fatal:"red",debug:"green",warn:"yellow"});var b={fatal:0,error:1,warn:2,info:3,debug:4},t=e__namespace.createLogger({levels:b,level:"info",format:e__namespace.format.combine(e__namespace.format.splat(),e__namespace.format.colorize(),e__namespace.format.printf(({level:o,message:a})=>`${o}: ${a}`)),transports:[new e__namespace.transports.Console]});var r="@userway/cicd-cli",p="0.1.2";var s=class extends m__namespace.CoreVersionChecker{get message(){return `
